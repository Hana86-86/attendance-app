...
$wrapInForm = $form && !empty($form['action']) && $footer !== 'approve';
...
<form method="post" action="{{ $formAction }}" novalidate>
  ...
  <div class="card">
    ...
    <div style="text-align:right; margin-top:12px;">
      ...
      @case('approve') {{-- 管理者：申請承認（更新フォームとは別送信） --}}
      <form method="post" action="{{ route('admin.requests.approve') }}" style="display:inline;">
        @csrf
